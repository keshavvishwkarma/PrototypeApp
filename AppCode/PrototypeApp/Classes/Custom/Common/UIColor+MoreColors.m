...
//Custom Colours
+ (id)pfedTurquoise                                     {vendColor(120, 169, 161);}
+ (id)ulsterScots                                       {vendColor(149, 181, 223);}
+ (id)fleadhCheoil                                      {vendColor(51, 51, 51);}
+ (id)ulsterScotsNavBar                                 {vendColor(138, 172, 218);}


+ (id)customColorWithRGB:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue {
    vendColor(red, green, blue);
}
