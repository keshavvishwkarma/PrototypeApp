...
- (void)drawRect:(CGRect)rect
{
    // Drawing text
    {
        ...
        CGSize size = [str sizeWithFont:font constrainedToSize:CGSizeMake(280, 480) lineBreakMode:NSLineBreakByWordWrapping];
        [str drawInRect:CGRectMake(20, 100, size.width, size.height) withFont:font lineBreakMode:NSLineBreakByWordWrapping];
    }
